...
<!--------------------------MODIFICAR PROYECTO------------------------------------>
        <?php
         $proyecto=$_POST["enviarConsultarProyecto"];
                try{
                        require_once('conexion.php');
                        $sql= "SELECT * FROM PROYECTO WHERE '$proyecto' = ID_P";
                    ...
                    ?>
                                            ...
                                            <br>
                                            <form id="" method="POST" action="modificarProyecto_CoorGeneral.php" onsubmit="return validarFormNuevoProyecto(this)">
                                                <label class="lblForm">Nombre de proyecto :</label>
                                                <br>
                                                <input class="ingresoDatos" type="text" name="nombreProyecto" value="<?php echo  $datos['NOMBRE_P'];?>">
                                                <br>
                                                <br>
                                                <label class="lblForm">Descripcion :</label>
                                                <br>
                                                <input class="ingresoDatos" type="text" name="descripcionProyecto" value="<?php echo  $datos['DESCRIPCION_P'];?>">
                                                <br>  
                                                <br> 
                                                <label class="lblForm">Fecha de Inicio :</label>
                                                <input type="date" name="fechaInicioProyecto" value="<?php echo  $datos['FECHAI_P'];?>">
                                                <br> 
                                                <br> 
                                                <label class="lblForm">Fecha de Fin :</label>
                                                <input type="date" name="fechaFinProyecto" value="<?php echo  $datos['FECHAF_P'];?>">
                                                <br>  
                                                <br> 
                                                ...
                                                <br>
                                                              <?php
                                                                try{
                                                                    ...
                                                                    $sql="SELECT * FROM USUARIO WHERE TIPO_USUARIO='Coordinador Facultad'";
                                                                    $resultado=$conn->query($sql);
                                                                } catch (Exception $ex) {
                                                                    $error = $ex->getMessage();
                                                                }
                                           ...
                                           <label >Estado proyecto:</label>
                                             ...
                                             <select class="ingresoDatos" name="estadoProyecto">
                                                  <option>En Proceso</option>
                                                  <option>Finalizado</option>
                                             </select>   
                                             <br>
                                             <input type="hidden" name="envioIdProyecto" id="envioIdProyecto" value="<?php echo $proyecto?>">
                                                <center><input class ="boton"type="submit" name="Enviar" value="Modificar Proyecto"></center>
                                            </form>

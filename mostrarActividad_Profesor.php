            ...
            <div class="formInDatos2">                                
                ...
                <?php
                    ...
                    try{
                        ...
                        $sql = "SELECT A.ID_A,A.ID_E,A.CEDULA_CC,A.CEDULA_D,A.CEDULA_E,A.NOMBRE_A,A.DESCRIPCION_A,A.ESTADO_A,A.FECHA_I_A,A.FECHA_F_A
from ACTIVIDAD as A  INNER JOIN EVENTO ON A.ID_E = EVENTO.ID_E
WHERE A.CEDULA_D = '$cedulaP' ";

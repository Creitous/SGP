                ...
                <?php
                    ...
                    try{
                        ...
                        $sql = "SELECT P.ID_P , P.CEDULA_CG, P.CEDULA_REPE , P.CEDULA_CF,P.NOMBRE_P,P.DESCRIPCION_P,P.ESTADO_P,P.FECHAI_P,P.FECHAF_P
                                from PROYECTO AS P  INNER JOIN  EVENTO as d  ON  P.ID_P = d.ID_P
                                WHERE d.CEDULA_CC = '$cedulaCC';
                                ";
                       ...
                       while ($row = $result ->fetch_array()){
                           printf ("
                               <tr>
                                   ...
                                   <td>&nbsp;%s&nbsp;</td>
                                   <td>&nbsp;%s&nbsp;</td>
                                   <td><center><a href=\"mostarEvento_coorCarrera.php?id_p=%s\"> <i class=\"far fa-eye\"></i> </a></center></td>
                               </tr>",

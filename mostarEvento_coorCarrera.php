            ...
            <div class="formInDatos2">                                
                ...
                <?php
                    ...
                    try{
                        ...
                        $sql = "SELECT  * from  EVENTO WHERE ID_P='$id_p' AND CEDULA_CC = '$cedulaCC' ";
                       ...
                       while ($row = $result ->fetch_array()){
                           printf ("
                               <tr>
                                   ...
                                   <td>&nbsp;%s&nbsp;</td>
                                   <td>&nbsp;%s&nbsp;</td>
                                   <td><center><a href=\"mostarActividad_coorCarrera.php?id_e=%s\"> <i class=\"far fa-eye\"></i> </a></center></td>
                                  
                               </tr>",
                                   
                               $row["ID_E"],$row["ID_P"],$row["CEDULA_CF"],
                               $row["CEDULA_CC"],$row["NOMBRE_E"],$row["DESCRIPCION_E"],$row["ESTADO_E"],$row["FECHA_I_E"],$row["FECHA_F_E"],$row["ID_E"]
                           );

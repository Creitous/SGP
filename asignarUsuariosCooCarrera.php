...
try {
    ...
    $sql1 = "select * from USUARIO where TIPO_USUARIO ='Estudiante'";
    $sql2= "select * from USUARIO where TIPO_USUARIO ='Docente'";
    $sql3 = "select * from ACTIVIDAD";
...
<html>
    ...
    <body>
        ...
        <div class="container" style="border: 2px solid #01a7b3 ; border-radius: 8px">
            ...
            <div class="cabeceraIndex">
                <h2 style="font-family: cursive">ASIGNACION DE TRABAJO </h2>
            </div><!--finde de la cabecera-->
                                    ...
                                    <div class="container" style="width:700px ;height: 600px">
                                        <div class="row">
                                            ...
                                            <div class="datos1" >
                                                ...
                                                <label id="nombre">Actividad: </label>
                                                <select class="ingresoDatos" id="evento" name ="actividad">
                                                    <option>Seleccion Actividad....</option>
                                                    <?php
                                                    while ($valores = mysqli_fetch_array($resultado3)) {
                                                         echo '<option value="' . $valores['ID_A'] . '">' . $valores['NOMBRE_A'] . '</option>';
                                                    }
                                                    ?>
                                                </select>
                                                <br>
                                                ...
                                                <select class="ingresoDatos" id="evento" name ="profesor">
                                                    <option>Seleccion Docente....</option>
                                                    <?php
                                                    while ($valores = mysqli_fetch_array($resultado2)) {
                                                        echo '<option value="' . $valores['CEDULA'] . '">'. $valores['NOMBRE'] .'</option>';
                                                    }
                                                    ?>
                                                </select>
                                                <br>
                                                ...
                                                <select class="ingresoDatos" id="evento" name ="estudiante">
                                                    <option>Seleccion Estudiante....</option>
                                                    <?php
